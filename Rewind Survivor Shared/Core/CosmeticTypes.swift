...
struct CosmeticCatalog {
    static let skins: [CosmeticItem] = [
        ...
        CosmeticItem(id: "skin_crimson", category: .skin, displayName: "Crimson Ops", description: "Blood red armor", price: 3000, previewColor: SKColor(red: 1.0, green: 0.2, blue: 0.2, alpha: 1.0), primaryColor: SKColor(red: 1.0, green: 0.2, blue: 0.2, alpha: 1.0), secondaryColor: SKColor(red: 0.6, green: 0.0, blue: 0.0, alpha: 1.0)),
        CosmeticItem(id: "skin_toxic", category: .skin, displayName: "Toxic Hazard", description: "Radioactive green", price: 3000, previewColor: SKColor(red: 0.0, green: 1.0, blue: 0.3, alpha: 1.0), primaryColor: SKColor(red: 0.0, green: 1.0, blue: 0.3, alpha: 1.0), secondaryColor: SKColor(red: 0.0, green: 0.5, blue: 0.15, alpha: 1.0)),
        CosmeticItem(id: "skin_gold", category: .skin, displayName: "Gold Edition", description: "Prestigious plating", price: 15000, previewColor: ColorPalette.gold, primaryColor: ColorPalette.gold, secondaryColor: SKColor(red: 0.7, green: 0.5, blue: 0.0, alpha: 1.0)),
        CosmeticItem(id: "skin_void", category: .skin, displayName: "Void Walker", description: "From beyond the rift", price: 8000, previewColor: ColorPalette.rewindMagenta, primaryColor: ColorPalette.rewindMagenta, secondaryColor: ColorPalette.rewindPurple),
        CosmeticItem(id: "skin_skeleton", category: .skin, displayName: "Bone Reaper", description: "Skull face, exposed ribs", price: 6000, previewColor: SKColor(red: 0.9, green: 0.9, blue: 0.85, alpha: 1.0), primaryColor: SKColor(red: 0.9, green: 0.9, blue: 0.85, alpha: 1.0), secondaryColor: SKColor(red: 0.5, green: 0.5, blue: 0.45, alpha: 1.0)),
    ...
    static let hats: [CosmeticItem] = [
        ...
        CosmeticItem(id: "hat_crown", category: .hat, displayName: "Royal Crown", description: "Rule the arena", price: 10000, previewColor: ColorPalette.gold),
        CosmeticItem(id: "hat_halo", category: .hat, displayName: "Angel Halo", description: "Divine protection", price: 5000, previewColor: SKColor(red: 1.0, green: 1.0, blue: 0.7, alpha: 1.0)),
        CosmeticItem(id: "hat_horns", category: .hat, displayName: "Demon Horns", description: "Embrace the darkness", price: 5000, previewColor: SKColor(red: 0.8, green: 0.0, blue: 0.0, alpha: 1.0)),
        CosmeticItem(id: "hat_wizard", category: .hat, displayName: "Wizard Hat", description: "Arcane knowledge", price: 6000, previewColor: SKColor(red: 0.4, green: 0.2, blue: 0.8, alpha: 1.0)),
    ...
    static let trails: [CosmeticItem] = [
        ...
        CosmeticItem(id: "trail_fire", category: .trail, displayName: "Flame Trail", description: "Leave fire in your wake", price: 4000, previewColor: SKColor(red: 1.0, green: 0.4, blue: 0.0, alpha: 1.0), trailColor: SKColor(red: 1.0, green: 0.4, blue: 0.0, alpha: 1.0)),
        CosmeticItem(id: "trail_ice", category: .trail, displayName: "Frost Trail", description: "Chilling presence", price: 4000, previewColor: ColorPalette.freezeAuraBlue, trailColor: ColorPalette.freezeAuraBlue),
        CosmeticItem(id: "trail_shadow", category: .trail, displayName: "Shadow Trail", description: "Dark afterimages", price: 7000, previewColor: SKColor(red: 0.3, green: 0.0, blue: 0.5, alpha: 1.0), trailColor: SKColor(red: 0.3, green: 0.0, blue: 0.5, alpha: 1.0)),
